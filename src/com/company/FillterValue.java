...
public class FillterValue {
    ...
    // --------------------------------------------------------------- 1 способ (нет) - поиск по нужному символу (не оптимизоравно, сложно и нагромождено)
    ...
    // --------------------------------------------------------------- 2 способ (нет) - регулярные вырожения RegEx (сложность учесть нюансы)
    ...
    // --------------------------------------------------------------- 3 способ (да) - поиск черз внутреную проверку, при парсинге (быстро и легко)
